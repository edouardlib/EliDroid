package be.makingidea.androidboilerplate.runner;

import android.os.Bundle;
import android.support.test.espresso.Espresso;

import be.makingidea.androidboilerplate.util.RxIdlingExecutionHook;
import be.makingidea.androidboilerplate.util.RxIdlingResource;
